                      ...
                      bool                   &ovflo)
{
    ...
    #pragma HLS STREAM variable=fft2_in  depth=256
    #pragma HLS STREAM variable=fft2_out depth=256
    #pragma HLS STREAM variable=cfg2_s   depth=256
    #pragma HLS STREAM variable=sts2_s   depth=256
    ...
    bool                  &ovflo)
{
    ...
    bool ovflo1 = false, ovflo2 = false;
