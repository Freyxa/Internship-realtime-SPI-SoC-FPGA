...
## SPI by means of Fast Fourier Transform (FFT)
...
In the Zynq UltraScale+ ecosystem, the Jupyter Notebook serves as the primary integrated development environment (IDE) and documentation tool. It runs as a web server directly on the ARM processing system. Utility for Project Tracking: 
...
<img width="2368" height="2639" alt="image" src="https://github.com/user-attachments/assets/49eecc71-e9c6-4b3d-9bf7-2526a3df6c44" />
...
<img width="2785" height="1236" alt="image" src="https://github.com/user-attachments/assets/3b327ad6-60f7-48d4-9077-42226707fb90" />
